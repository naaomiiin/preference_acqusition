...
<html>
 <head>
    ...
    <title>対話システム２終了</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css/experiment2_finish.css">
      ...
      <div class="container">
        <div class="row" style="height:500px;">
          <div class="col-sm-12"> <!-- カラム 1 ここから -->
            ...
            <br>
            <h3>これで対話システム２についての評価実験はおしまいです。<br>
...
open(OUT, ">>", $filename);
print OUT $name,",",$age,",",$sex,",system2,",$question_01,",",$question_02,",",$question_03,",",$question_04,",",$question_05,",",$question_06,"\n";
close(OUT);
