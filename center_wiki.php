...
$count_data=0;
$count_data=count($mysql_data_array);  
print $count_data;
//    $index = $n - 1;
$index= ceil($count_data/2)-1;
print $mysql_data_array[434];
