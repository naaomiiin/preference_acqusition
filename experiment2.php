...
<html lang="ja">
  <head>
    ...
    <title>対話システム２アンケート</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css/experiment2.css">
...
<br>
  ...
  <img src="./img/lace8.png" id="left_lace">
  <img src="./img/lace8.png" id="right_lace">
<p>
   <h3>アンケートに関する説明</h3><br>
   <p id="agreement"> ここではあなた自身のことと, 対話システム２との対話について, 以下の質問に回答して頂きます. <br> 
    ...
    <font size="4" color="#12397a"><strong>※ システムの返答の際にかかった時間は考慮せずに回答してください.</strong></font></p>
  <br>
  <p>
   <form id="subject_personality" action="experiment2.cgi" method="POST">
