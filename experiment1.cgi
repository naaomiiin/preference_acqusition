...
<html>
 <head>
    ...
    <title>対話システム１終了</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css/experiment1_finish.css">
      ...
      <div class="container">
        <div class="row" style="height:500px;">
          <div class="col-sm-12"> <!-- カラム 1 ここから -->
            ...
            <br>
            <h3>これで対話システム１についての評価実験はおしまいです。<br>
...
open(OUT, ">>", $filename);
print OUT $name,",",$age,",",$sex,",system1,",$question_01,",",$question_02,",",$question_03,",",$question_04,",",$question_05,",",$question_06,"\n";
close(OUT);
